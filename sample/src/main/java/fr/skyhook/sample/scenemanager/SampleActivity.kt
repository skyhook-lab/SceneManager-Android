...
class SampleActivity : FragmentActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.sample_switch_to_custom_view -> SceneManager.scene(this,
                SAMPLE_WITH_VIEW
            )
            ...
            R.id.sample_switch_to_existing_layout ->
                SampleNoAnnotationsActivity.startActivity(
                    this
                )
            R.id.sample_switch_to_bind_scenes ->
                SampleBindScenesActivity.startActivity(
                    this
                )
            R.id.sample_switch_to_iod ->
                SampleInflateOnDemandActivity.startActivity(
                    this
                )
            R.id.sample_hide -> {
                SceneManager.scene(
